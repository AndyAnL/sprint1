# Спринт 1: Создание и настройка инфраструктуры
...
1. Измените публичный ip адрес сервера srv в start-tunnel.sh

   ```bash
   SRV_IP=
   ```

2. запустите туннель для доступа к внутренним ресурсам:
